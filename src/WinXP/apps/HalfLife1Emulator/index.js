...
function HalfLife1Emulator() {
  ...
  // Half-Life 1 URL
  const gameUrl = 'https://pixelsuft.github.io/hl/';

  return (
    <Container ref={containerRef}>
      <LoadingOverlay id="loading-overlay-hl1">
        <LoadingText>Half-Life 1 yükleniyor...</LoadingText>
      </LoadingOverlay>
      <IframeContainer>
        <iframe
          ref={iframeRef}
...
export default HalfLife1Emulator;
